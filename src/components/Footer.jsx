...
const links = [
  { href: "https://www.github.com/hamzaisadev", icon: <FaGithub /> },
  { href: "https://www.linkedin.com/in/hamzaisadev", icon: <FaLinkedin /> },
];
    ...
    <footer className="w-screen bg-violet-300 py-4 text-black">
      <div className="container mx-auto flex flex-col items-center justify-center gap-4 px-4 md:flex-row">
        <p className="text-center text-sm">
          &copy;Arcane 2024 . All content rights reserved.
        </p>
        <p className="text-center text-sm">
